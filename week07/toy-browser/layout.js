 ...
 * @LastEditTime: 2020-05-31 22:40:26
 */
  ...
  if (mainSpace < 0) {
    ...
    flexLines.forEach(function(items){
      ...
      if (flexTotal > 0) {
        ...
        for (var i = 0; i < items.length; i++) {
          var item = items[i]
          var itemStyle = item.getStyle(item)
        ...
        if (style.justifyContent === 'flex-end') {
          var currentMain = mainSpace * mainSize + mainBase
          var step = 0
        }

        if (style.justifyContent === 'center') {
          var currentMain = (mainSpace / 2) * mainSize + mainBase
          var step = 0
        }
